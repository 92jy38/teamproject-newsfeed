...
public class MemberController {
     ...
     */
    @PostMapping("/members")
    public ResponseEntity<ResponseStatusDto> createUser(@RequestBody RequestCreateMemberDto requestDto) {
        try {
     ...
     */
    @GetMapping("/members")
    public ResponseEntity<ResponseMemberDto> getUserInfo(HttpServletRequest req) {
        try {
            return ResponseEntity
                    .status(HttpStatus.OK)
                    .body(memberService.searchMember(req));
        } catch (ResponseException ex) {
            return ResponseEntity
                    .status(ex.getResponseCode().getHttpStatus())
     ...
     */
    @PutMapping("/members")
    public ResponseEntity<ResponseStatusDto> updateUser(HttpServletRequest req, @RequestBody RequestModifyMemberDto requestDto) {
        try {
            return ResponseEntity
                    .status(HttpStatus.OK)
    ...
    public ResponseEntity<ResponseStatusDto> deleteUser(HttpServletRequest req, @RequestBody RequestRemoveMemberDto requestDto) {
        try {
            return ResponseEntity
                    .status(HttpStatus.OK)
